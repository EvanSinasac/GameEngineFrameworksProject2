...
class cSpaceInvader_Bomb :
	public cSpaceInvader
{
public:
	cSpaceInvader_Bomb();
	virtual ~cSpaceInvader_Bomb();
	...
	bool loadBlockPose3(std::string fileName);
