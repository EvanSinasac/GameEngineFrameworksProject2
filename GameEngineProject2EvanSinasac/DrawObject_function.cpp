...
//        GLuint TextureNumber = ::g_pTextureManager->getTextureIDFromName("Broc_tree_house.bmp");
    ...
    // Set up the blend values for the skyboxes
    {
        ...
        float howMuch_cubeMap_00 = 0.5f;
        float howMuch_cubeMap_01 = 0.5f;
    ...
    cVAOManager* pVAOManager)
{
    ...
    {
        // I'm using an invisible block as my "base" for each alien / ship, so I still want to draw the children meshes before returning
        // AAAAAANNNNNDDDD
        // I need to figure out the base object's position, just without drawing it
